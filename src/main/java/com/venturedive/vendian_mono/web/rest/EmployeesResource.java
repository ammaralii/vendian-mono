...
import com.venturedive.vendian_mono.service.EmployeesQueryService;
...
/**
 * REST controller for managing {@link com.venturedive.vendian_mono.domain.Employees}.
 */
@RestController
@RequestMapping("/api")
public class EmployeesResource {
    ...
    public ResponseEntity<Employees> updateEmployees(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, employees.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Employees> partialUpdateEmployees(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, employees.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Employees>> getAllEmployees(
        ...
        Page<Employees> page = employeesQueryService.findByCriteria(criteria, pageable);
