...
import com.venturedive.vendian_mono.service.AttributesQueryService;
import com.venturedive.vendian_mono.service.AttributesService;
...
/**
 * REST controller for managing {@link com.venturedive.vendian_mono.domain.Attributes}.
 */
@RestController
@RequestMapping("/api")
public class AttributesResource {
    ...
    private final AttributesQueryService attributesQueryService;

    public AttributesResource(
        AttributesService attributesService,
        AttributesRepository attributesRepository,
        AttributesQueryService attributesQueryService
    ) {
        this.attributesService = attributesService;
        this.attributesRepository = attributesRepository;
        this.attributesQueryService = attributesQueryService;
    }
    ...
    public ResponseEntity<Attributes> updateAttributes(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, attributes.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Attributes> partialUpdateAttributes(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, attributes.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Attributes>> getAllAttributes(
        AttributesCriteria criteria,
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get Attributes by criteria: {}", criteria);
        Page<Attributes> page = attributesQueryService.findByCriteria(criteria, pageable);
    ...
    public ResponseEntity<Long> countAttributes(AttributesCriteria criteria) {
        log.debug("REST request to count Attributes by criteria: {}", criteria);
        return ResponseEntity.ok().body(attributesQueryService.countByCriteria(criteria));
    }
