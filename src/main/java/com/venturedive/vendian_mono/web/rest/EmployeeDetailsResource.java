...
import com.venturedive.vendian_mono.service.EmployeeDetailsQueryService;
import com.venturedive.vendian_mono.service.EmployeeDetailsService;
...
/**
 * REST controller for managing {@link com.venturedive.vendian_mono.domain.EmployeeDetails}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeDetailsResource {
    ...
    public ResponseEntity<EmployeeDetails> createEmployeeDetails(@Valid @RequestBody EmployeeDetails employeeDetails)
