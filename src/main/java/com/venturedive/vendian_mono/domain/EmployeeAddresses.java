...
public class EmployeeAddresses implements Serializable {
    ...
    @NotNull
    @JsonIgnoreProperties(value = { "employeeaddressesAddresses" }, allowSetters = true)
    ...
    public EmployeeAddresses id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public EmployeeAddresses isdeleted(Boolean isdeleted) {
    ...
    public EmployeeAddresses createdat(Instant createdat) {
    ...
    public EmployeeAddresses updatedat(Instant updatedat) {
    ...
    public EmployeeAddresses type(String type) {
        this.setType(type);
        return this;
    }
    ...
    public EmployeeAddresses address(Addresses addresses) {
    ...
    public EmployeeAddresses employee(Employees employees) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmployeeAddresses)) {
            return false;
        }
        return id != null && id.equals(((EmployeeAddresses) o).id);
    }
