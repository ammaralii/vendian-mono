...
public class UserRelations implements Serializable {
    ...
    @Size(max = 7)
    @Column(name = "reference_type", length = 7)
    ...
    public UserRelations id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public UserRelations referenceType(String referenceType) {
    ...
    public UserRelations referenceId(Integer referenceId) {
    ...
    public UserRelations effDate(Instant effDate) {
    ...
    public UserRelations createdAt(Instant createdAt) {
    ...
    public UserRelations updatedAt(Instant updatedAt) {
    ...
    public UserRelations endDate(Instant endDate) {
    ...
    public UserRelations version(Integer version) {
    ...
    public UserRelations user(Employees employees) {
    ...
    public UserRelations attribute(Attributes attributes) {
        this.setAttribute(attributes);
        return this;
    }

    public Employees getRelatedUser() {
        return this.relatedUser;
    }

    public void setRelatedUser(Employees employees) {
        this.relatedUser = employees;
    }

    public UserRelations relatedUser(Employees employees) {
        this.setRelatedUser(employees);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserRelations)) {
            return false;
        }
        return id != null && id.equals(((UserRelations) o).id);
    }
