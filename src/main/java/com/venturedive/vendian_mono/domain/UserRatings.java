...
public class UserRatings implements Serializable {
    ...
    @NotNull
    @Size(max = 7)
    @Column(name = "rating", length = 7, nullable = false)
    ...
    public UserRatings rating(String rating) {
    ...
    public UserRatings comment(String comment) {
    ...
    public UserRatings createdAt(Instant createdAt) {
    ...
    public UserRatings updatedAt(Instant updatedAt) {
    ...
    public UserRatings deletedAt(Instant deletedAt) {
    ...
    public UserRatings version(Integer version) {
    ...
    public UserRatings user(Employees employees) {
    ...
    public UserRatings reviewManager(Employees employees) {
    ...
    public UserRatings performanceCycle(HrPerformanceCycles hrPerformanceCycles) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserRatings)) {
            return false;
        }
        return id != null && id.equals(((UserRatings) o).id);
    }
