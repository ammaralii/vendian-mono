...
/**
 * A NotificationSentEmailLogs.
 */
@Entity
@Table(name = "notification_sent_email_logs")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NotificationSentEmailLogs implements Serializable {
    ...
    public NotificationSentEmailLogs id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public NotificationSentEmailLogs email(String email) {
        this.setEmail(email);
        return this;
    }
    ...
    public NotificationSentEmailLogs createdAt(Instant createdAt) {
    ...
    public NotificationSentEmailLogs updatedAt(Instant updatedAt) {
    ...
    public NotificationSentEmailLogs deletedAt(Instant deletedAt) {
    ...
    public NotificationSentEmailLogs version(Integer version) {
    ...
    public NotificationTemplates getNotificationTemplate() {
        return this.notificationTemplate;
    }

    public void setNotificationTemplate(NotificationTemplates notificationTemplates) {
        this.notificationTemplate = notificationTemplates;
    }

    public NotificationSentEmailLogs notificationTemplate(NotificationTemplates notificationTemplates) {
        this.setNotificationTemplate(notificationTemplates);
        return this;
    }
    ...
    public void setRecipient(Employees employees) {
        this.recipient = employees;
    }

    public NotificationSentEmailLogs recipient(Employees employees) {
        this.setRecipient(employees);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotificationSentEmailLogs)) {
            return false;
        }
        return id != null && id.equals(((NotificationSentEmailLogs) o).id);
    }
