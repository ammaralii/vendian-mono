...
/**
 * A EmployeeEmergencyContacts.
 */
@Entity
@Table(name = "employee_emergency_contacts")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeEmergencyContacts implements Serializable {
    ...
    @NotNull
    @Size(max = 255)
    @Column(name = "contactno", length = 255, nullable = false)
    ...
    public EmployeeEmergencyContacts id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public EmployeeEmergencyContacts fullname(String fullname) {
    ...
    public EmployeeEmergencyContacts relationship(String relationship) {
    ...
    public EmployeeEmergencyContacts contactno(String contactno) {
    ...
    public EmployeeEmergencyContacts createdat(Instant createdat) {
    ...
    public EmployeeEmergencyContacts updatedat(Instant updatedat) {
    ...
    public EmployeeEmergencyContacts employee(Employees employees) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmployeeEmergencyContacts)) {
            return false;
        }
        return id != null && id.equals(((EmployeeEmergencyContacts) o).id);
    }
