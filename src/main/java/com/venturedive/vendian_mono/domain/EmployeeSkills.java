...
public class EmployeeSkills implements Serializable {
    ...
    public EmployeeSkills id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public EmployeeSkills createdat(Instant createdat) {
    ...
    public EmployeeSkills updatedat(Instant updatedat) {
    ...
    public EmployeeSkills expertise(Integer expertise) {
    ...
    public EmployeeSkills employee(Employees employees) {
    ...
    public EmployeeSkills skill(Skills skills) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmployeeSkills)) {
            return false;
        }
        return id != null && id.equals(((EmployeeSkills) o).id);
    }
