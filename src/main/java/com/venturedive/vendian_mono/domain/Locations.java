...
public class Locations implements Serializable {
    ...
    private Set<Employees> employeesLocations = new HashSet<>();
    ...
    public Locations createdat(Instant createdat) {
    ...
    public Locations updatedat(Instant updatedat) {
    ...
    public Locations deletedat(Instant deletedat) {
    ...
    public Set<Employees> getEmployeesLocations() {
        return this.employeesLocations;
    }

    public void setEmployeesLocations(Set<Employees> employees) {
        if (this.employeesLocations != null) {
            this.employeesLocations.forEach(i -> i.setLocation(null));
        }
        if (employees != null) {
            employees.forEach(i -> i.setLocation(this));
        }
        this.employeesLocations = employees;
    }

    public Locations employeesLocations(Set<Employees> employees) {
        this.setEmployeesLocations(employees);
        return this;
    }

    public Locations addEmployeesLocation(Employees employees) {
        this.employeesLocations.add(employees);
        employees.setLocation(this);
        return this;
    }

    public Locations removeEmployeesLocation(Employees employees) {
        this.employeesLocations.remove(employees);
        employees.setLocation(null);
        return this;
    }
