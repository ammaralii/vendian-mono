...
/**
 * Criteria class for the {@link com.venturedive.vendian_mono.domain.PerformanceCycles} entity. This class is used
 * in {@link com.venturedive.vendian_mono.web.rest.PerformanceCyclesResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /performance-cycles?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PerformanceCyclesCriteria implements Serializable, Criteria {
    ...
    private LongFilter employeeratingId;

    private Boolean distinct;

    public PerformanceCyclesCriteria() {}

    public PerformanceCyclesCriteria(PerformanceCyclesCriteria other) {
        ...
        this.employeeratingId = other.employeeratingId == null ? null : other.employeeratingId.copy();
        this.distinct = other.distinct;
    }

    @Override
    public PerformanceCyclesCriteria copy() {
        return new PerformanceCyclesCriteria(this);
    }
    ...
    public LongFilter getEmployeeratingId() {
        return employeeratingId;
    }

    public LongFilter employeeratingId() {
        if (employeeratingId == null) {
            employeeratingId = new LongFilter();
        }
        return employeeratingId;
    }

    public void setEmployeeratingId(LongFilter employeeratingId) {
    ...
    public boolean equals(Object o) {
        ...
        final PerformanceCyclesCriteria that = (PerformanceCyclesCriteria) o;
        return (
            ...
            Objects.equals(employeeratingId, that.employeeratingId) &&
    ...
    public String toString() {
        return "PerformanceCyclesCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            ...
            (employeeratingId != null ? "employeeratingId=" + employeeratingId + ", " : "") +
