...
/**
 * Criteria class for the {@link com.venturedive.vendian_mono.domain.UserAttributeApprovalRules} entity. This class is used
 * in {@link com.venturedive.vendian_mono.web.rest.UserAttributeApprovalRulesResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /user-attribute-approval-rules?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class UserAttributeApprovalRulesCriteria implements Serializable, Criteria {
    ...
    public UserAttributeApprovalRulesCriteria() {}

    public UserAttributeApprovalRulesCriteria(UserAttributeApprovalRulesCriteria other) {
    ...
    @Override
    public UserAttributeApprovalRulesCriteria copy() {
        return new UserAttributeApprovalRulesCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final UserAttributeApprovalRulesCriteria that = (UserAttributeApprovalRulesCriteria) o;
        return (
    ...
    public String toString() {
        return "UserAttributeApprovalRulesCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
