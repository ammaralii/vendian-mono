...
/**
 * Criteria class for the {@link com.venturedive.vendian_mono.domain.LeavesCopy} entity. This class is used
 * in {@link com.venturedive.vendian_mono.web.rest.LeavesCopyResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /leaves-copies?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class LeavesCopyCriteria implements Serializable, Criteria {
    ...
    public LeavesCopyCriteria() {}

    public LeavesCopyCriteria(LeavesCopyCriteria other) {
    ...
    @Override
    public LeavesCopyCriteria copy() {
        return new LeavesCopyCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LeavesCopyCriteria that = (LeavesCopyCriteria) o;
        return (
