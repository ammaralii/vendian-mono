...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESIGNATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DESIGNATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DESIGNATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DESIGNATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DESIGNATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DESIGNATIONS actions', async () => {
      const expectedActions = [
        {
