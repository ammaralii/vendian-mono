...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './rating-attribute-mappings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RATINGATTRIBUTEMAPPINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RATINGATTRIBUTEMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RATINGATTRIBUTEMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RATINGATTRIBUTEMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RATINGATTRIBUTEMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RATINGATTRIBUTEMAPPINGS actions', async () => {
      const expectedActions = [
        {
