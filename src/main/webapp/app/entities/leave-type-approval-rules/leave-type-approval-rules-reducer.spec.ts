...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-type-approval-rules.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVETYPEAPPROVALRULES_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVETYPEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVETYPEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVETYPEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVETYPEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVETYPEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
