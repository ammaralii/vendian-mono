...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './questions-frequency-per-track.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONSFREQUENCYPERTRACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUESTIONSFREQUENCYPERTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUESTIONSFREQUENCYPERTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUESTIONSFREQUENCYPERTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONSFREQUENCYPERTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUESTIONSFREQUENCYPERTRACK actions', async () => {
      const expectedActions = [
        {
