...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reasons.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REASONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REASONS actions', async () => {
      const expectedActions = [
        {
