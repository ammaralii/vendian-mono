...
export const DepartmentsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="vendianMonoApp.departments.delete.question">
        Are you sure you want to delete Departments {departmentsEntity.id}?
      </ModalBody>
      <ModalFooter>
