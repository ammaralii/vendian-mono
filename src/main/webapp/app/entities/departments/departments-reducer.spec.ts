...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPARTMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEPARTMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPARTMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPARTMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPARTMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPARTMENTS actions', async () => {
      const expectedActions = [
        {
