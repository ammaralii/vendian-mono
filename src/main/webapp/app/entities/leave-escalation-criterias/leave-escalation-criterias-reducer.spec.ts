...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-escalation-criterias.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEESCALATIONCRITERIAS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEESCALATIONCRITERIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEESCALATIONCRITERIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEESCALATIONCRITERIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEESCALATIONCRITERIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEESCALATIONCRITERIAS actions', async () => {
      const expectedActions = [
        {
