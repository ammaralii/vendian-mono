...
export const ProjectsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="vendianMonoApp.projects.delete.question">Are you sure you want to delete Projects {projectsEntity.id}?</ModalBody>
      <ModalFooter>
