...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPROVERGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPROVERGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPROVERGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPROVERGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPROVERGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPROVERGROUPS actions', async () => {
      const expectedActions = [
        {
