...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './questions-frequency-per-client-track.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONSFREQUENCYPERCLIENTTRACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUESTIONSFREQUENCYPERCLIENTTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUESTIONSFREQUENCYPERCLIENTTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUESTIONSFREQUENCYPERCLIENTTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONSFREQUENCYPERCLIENTTRACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUESTIONSFREQUENCYPERCLIENTTRACK actions', async () => {
      const expectedActions = [
        {
