...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './project-leadership.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTLEADERSHIP_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTLEADERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTLEADERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTLEADERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTLEADERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTLEADERSHIP actions', async () => {
      const expectedActions = [
        {
