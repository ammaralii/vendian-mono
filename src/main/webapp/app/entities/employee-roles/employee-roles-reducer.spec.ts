...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEROLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEROLES actions', async () => {
      const expectedActions = [
        {
