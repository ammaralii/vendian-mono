...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-attribute-escalation-rules.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERATTRIBUTEESCALATIONRULES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERATTRIBUTEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERATTRIBUTEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERATTRIBUTEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERATTRIBUTEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERATTRIBUTEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
