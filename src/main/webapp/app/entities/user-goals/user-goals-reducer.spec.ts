...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERGOALS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERGOALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERGOALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERGOALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERGOALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERGOALS actions', async () => {
      const expectedActions = [
        {
