...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-approval-criterias.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEAPPROVALCRITERIAS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEAPPROVALCRITERIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEAPPROVALCRITERIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEAPPROVALCRITERIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEAPPROVALCRITERIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEAPPROVALCRITERIAS actions', async () => {
      const expectedActions = [
        {
