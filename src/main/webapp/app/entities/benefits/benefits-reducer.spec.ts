...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './benefits.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEFITS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEFITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEFITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEFITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEFITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEFITS actions', async () => {
      const expectedActions = [
        {
