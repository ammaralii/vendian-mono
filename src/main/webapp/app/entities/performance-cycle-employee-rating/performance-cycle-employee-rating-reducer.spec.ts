...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './performance-cycle-employee-rating.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERFORMANCECYCLEEMPLOYEERATING_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERFORMANCECYCLEEMPLOYEERATING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERFORMANCECYCLEEMPLOYEERATING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERFORMANCECYCLEEMPLOYEERATING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERFORMANCECYCLEEMPLOYEERATING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERFORMANCECYCLEEMPLOYEERATING actions', async () => {
      const expectedActions = [
        {
