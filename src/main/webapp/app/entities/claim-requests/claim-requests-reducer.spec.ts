...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIMREQUESTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIMREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIMREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIMREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIMREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIMREQUESTS actions', async () => {
      const expectedActions = [
        {
