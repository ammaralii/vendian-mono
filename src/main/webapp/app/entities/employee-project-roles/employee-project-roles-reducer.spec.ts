...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-project-roles.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROJECTROLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROJECTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEPROJECTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEPROJECTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEPROJECTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEPROJECTROLES actions', async () => {
      const expectedActions = [
        {
