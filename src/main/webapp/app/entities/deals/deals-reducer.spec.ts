...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './deals.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALS actions', async () => {
      const expectedActions = [
        {
