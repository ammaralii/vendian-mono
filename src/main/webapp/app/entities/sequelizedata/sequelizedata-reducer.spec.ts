...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEQUELIZEDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEQUELIZEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEQUELIZEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEQUELIZEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEQUELIZEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEQUELIZEDATA actions', async () => {
      const expectedActions = [
        {
