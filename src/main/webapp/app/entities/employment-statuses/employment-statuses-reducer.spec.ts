...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employment-statuses.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYMENTSTATUSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYMENTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYMENTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYMENTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYMENTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYMENTSTATUSES actions', async () => {
      const expectedActions = [
        {
