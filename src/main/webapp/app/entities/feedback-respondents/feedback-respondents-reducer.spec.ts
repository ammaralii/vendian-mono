...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './feedback-respondents.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKRESPONDENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEEDBACKRESPONDENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEEDBACKRESPONDENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEEDBACKRESPONDENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKRESPONDENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEEDBACKRESPONDENTS actions', async () => {
      const expectedActions = [
        {
