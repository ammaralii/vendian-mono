...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './deal-resource-skills.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALRESOURCESKILLS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALRESOURCESKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALRESOURCESKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALRESOURCESKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALRESOURCESKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALRESOURCESKILLS actions', async () => {
      const expectedActions = [
        {
