...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './deal-resource-event-logs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALRESOURCEEVENTLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALRESOURCEEVENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALRESOURCEEVENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALRESOURCEEVENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALRESOURCEEVENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALRESOURCEEVENTLOGS actions', async () => {
      const expectedActions = [
        {
