...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PCRATINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PCRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PCRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PCRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PCRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PCRATINGS actions', async () => {
      const expectedActions = [
        {
