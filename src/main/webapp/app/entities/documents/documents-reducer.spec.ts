...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './documents.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCUMENTS actions', async () => {
      const expectedActions = [
        {
