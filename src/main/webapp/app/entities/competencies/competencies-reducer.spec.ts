...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETENCIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPETENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPETENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPETENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPETENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPETENCIES actions', async () => {
      const expectedActions = [
        {
