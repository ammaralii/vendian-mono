...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-request-approvers.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEREQUESTAPPROVERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEREQUESTAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEREQUESTAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEREQUESTAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEREQUESTAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEREQUESTAPPROVERS actions', async () => {
      const expectedActions = [
        {
