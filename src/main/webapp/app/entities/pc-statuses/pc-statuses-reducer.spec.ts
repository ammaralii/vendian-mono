...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PCSTATUSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PCSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PCSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PCSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PCSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PCSTATUSES actions', async () => {
      const expectedActions = [
        {
