...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALRESOURCES_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALRESOURCES actions', async () => {
      const expectedActions = [
        {
