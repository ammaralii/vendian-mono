...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKEMAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEEDBACKEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEEDBACKEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEEDBACKEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKEMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEEDBACKEMAILS actions', async () => {
      const expectedActions = [
        {
