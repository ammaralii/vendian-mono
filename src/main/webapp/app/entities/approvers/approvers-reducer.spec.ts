...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './approvers.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPROVERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPROVERS actions', async () => {
      const expectedActions = [
        {
