...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './divisions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIVISIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIVISIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIVISIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIVISIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIVISIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIVISIONS actions', async () => {
      const expectedActions = [
        {
