...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEETALENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEETALENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEETALENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEETALENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEETALENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEETALENTS actions', async () => {
      const expectedActions = [
        {
