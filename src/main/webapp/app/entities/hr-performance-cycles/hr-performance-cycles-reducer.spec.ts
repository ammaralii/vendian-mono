...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './hr-performance-cycles.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HRPERFORMANCECYCLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_HRPERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HRPERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HRPERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HRPERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HRPERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
