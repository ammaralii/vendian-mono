...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './compensation-benefits.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPENSATIONBENEFITS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPENSATIONBENEFITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPENSATIONBENEFITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPENSATIONBENEFITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPENSATIONBENEFITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPENSATIONBENEFITS actions', async () => {
      const expectedActions = [
        {
