...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './religions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELIGIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RELIGIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RELIGIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RELIGIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RELIGIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RELIGIONS actions', async () => {
      const expectedActions = [
        {
