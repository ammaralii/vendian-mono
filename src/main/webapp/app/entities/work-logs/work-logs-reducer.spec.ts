...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './work-logs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKLOGS actions', async () => {
      const expectedActions = [
        {
