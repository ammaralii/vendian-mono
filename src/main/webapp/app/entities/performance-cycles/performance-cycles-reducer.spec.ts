...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './performance-cycles.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERFORMANCECYCLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERFORMANCECYCLES actions', async () => {
      const expectedActions = [
        {
