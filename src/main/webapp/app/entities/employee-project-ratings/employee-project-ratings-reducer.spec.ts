...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-project-ratings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROJECTRATINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROJECTRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEPROJECTRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEPROJECTRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEPROJECTRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEPROJECTRATINGS actions', async () => {
      const expectedActions = [
        {
