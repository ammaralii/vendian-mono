...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-type-restrictions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVETYPERESTRICTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVETYPERESTRICTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVETYPERESTRICTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVETYPERESTRICTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVETYPERESTRICTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVETYPERESTRICTIONS actions', async () => {
      const expectedActions = [
        {
