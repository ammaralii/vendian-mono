...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUDITLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUDITLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUDITLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUDITLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUDITLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUDITLOGS actions', async () => {
      const expectedActions = [
        {
