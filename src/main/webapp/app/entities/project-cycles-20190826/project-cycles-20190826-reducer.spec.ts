...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './project-cycles-20190826.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTCYCLES20190826_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTCYCLES20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTCYCLES20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTCYCLES20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTCYCLES20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTCYCLES20190826 actions', async () => {
      const expectedActions = [
        {
