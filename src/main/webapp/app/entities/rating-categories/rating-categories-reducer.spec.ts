...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './rating-categories.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RATINGCATEGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_RATINGCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RATINGCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RATINGCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RATINGCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RATINGCATEGORIES actions', async () => {
      const expectedActions = [
        {
