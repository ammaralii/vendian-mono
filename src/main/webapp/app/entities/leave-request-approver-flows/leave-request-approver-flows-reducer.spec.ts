...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-request-approver-flows.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEREQUESTAPPROVERFLOWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEREQUESTAPPROVERFLOWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEREQUESTAPPROVERFLOWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEREQUESTAPPROVERFLOWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEREQUESTAPPROVERFLOWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEREQUESTAPPROVERFLOWS actions', async () => {
      const expectedActions = [
        {
