...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-comments.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEECOMMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEECOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEECOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEECOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEECOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEECOMMENTS actions', async () => {
      const expectedActions = [
        {
