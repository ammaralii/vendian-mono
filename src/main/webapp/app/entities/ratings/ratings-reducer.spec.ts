...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ratings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RATINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RATINGS actions', async () => {
      const expectedActions = [
        {
