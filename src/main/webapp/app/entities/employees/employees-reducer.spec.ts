...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './employees.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEES_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEES actions', async () => {
      const expectedActions = [
        {
