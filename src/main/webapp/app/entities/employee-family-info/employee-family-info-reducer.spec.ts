...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-family-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEFAMILYINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEFAMILYINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEFAMILYINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEFAMILYINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEFAMILYINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEFAMILYINFO actions', async () => {
      const expectedActions = [
        {
