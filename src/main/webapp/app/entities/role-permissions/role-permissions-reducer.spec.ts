...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROLEPERMISSIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROLEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROLEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROLEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROLEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROLEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
