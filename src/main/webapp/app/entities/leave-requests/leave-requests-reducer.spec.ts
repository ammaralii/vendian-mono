...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEREQUESTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEREQUESTS actions', async () => {
      const expectedActions = [
        {
