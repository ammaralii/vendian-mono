...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-documents.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEDOCUMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEDOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEDOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEDOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEDOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEDOCUMENTS actions', async () => {
      const expectedActions = [
        {
