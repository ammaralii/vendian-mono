...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKLOGDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKLOGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKLOGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKLOGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKLOGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKLOGDETAILS actions', async () => {
      const expectedActions = [
        {
