...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIMTYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIMTYPES actions', async () => {
      const expectedActions = [
        {
