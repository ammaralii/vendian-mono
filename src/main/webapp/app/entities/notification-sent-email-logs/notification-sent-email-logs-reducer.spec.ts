...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './notification-sent-email-logs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONSENTEMAILLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTIFICATIONSENTEMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTIFICATIONSENTEMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTIFICATIONSENTEMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONSENTEMAILLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTIFICATIONSENTEMAILLOGS actions', async () => {
      const expectedActions = [
        {
