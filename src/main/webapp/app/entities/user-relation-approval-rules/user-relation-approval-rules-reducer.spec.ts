...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-relation-approval-rules.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERRELATIONAPPROVALRULES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERRELATIONAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERRELATIONAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERRELATIONAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERRELATIONAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERRELATIONAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
