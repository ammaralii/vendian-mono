...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-projects.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROJECTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEPROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEPROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEPROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEPROJECTS actions', async () => {
      const expectedActions = [
        {
