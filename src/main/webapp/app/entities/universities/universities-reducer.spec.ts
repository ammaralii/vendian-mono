...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIVERSITIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNIVERSITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNIVERSITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNIVERSITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNIVERSITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNIVERSITIES actions', async () => {
      const expectedActions = [
        {
