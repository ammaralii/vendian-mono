...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-type-escalation-rules.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVETYPEESCALATIONRULES_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVETYPEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVETYPEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVETYPEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVETYPEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVETYPEESCALATIONRULES actions', async () => {
      const expectedActions = [
        {
