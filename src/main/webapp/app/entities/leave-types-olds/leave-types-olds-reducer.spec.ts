...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVETYPESOLDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVETYPESOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVETYPESOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVETYPESOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVETYPESOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVETYPESOLDS actions', async () => {
      const expectedActions = [
        {
