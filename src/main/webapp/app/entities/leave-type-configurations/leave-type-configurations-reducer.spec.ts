...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-type-configurations.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVETYPECONFIGURATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVETYPECONFIGURATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVETYPECONFIGURATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVETYPECONFIGURATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVETYPECONFIGURATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVETYPECONFIGURATIONS actions', async () => {
      const expectedActions = [
        {
