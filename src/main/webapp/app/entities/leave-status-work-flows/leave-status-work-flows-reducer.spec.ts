...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-status-work-flows.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVESTATUSWORKFLOWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVESTATUSWORKFLOWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVESTATUSWORKFLOWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVESTATUSWORKFLOWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVESTATUSWORKFLOWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVESTATUSWORKFLOWS actions', async () => {
      const expectedActions = [
        {
