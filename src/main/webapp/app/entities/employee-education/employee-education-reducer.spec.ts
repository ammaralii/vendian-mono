...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-education.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEEDUCATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEEDUCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEEDUCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEEDUCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEEDUCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEEDUCATION actions', async () => {
      const expectedActions = [
        {
