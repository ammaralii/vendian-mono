...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './leaves.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVES_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVES actions', async () => {
      const expectedActions = [
        {
