...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './feedback-responses.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKRESPONSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEEDBACKRESPONSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEEDBACKRESPONSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEEDBACKRESPONSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKRESPONSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEEDBACKRESPONSES actions', async () => {
      const expectedActions = [
        {
