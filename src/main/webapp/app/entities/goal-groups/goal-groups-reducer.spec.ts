...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GOALGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GOALGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GOALGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GOALGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GOALGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GOALGROUPS actions', async () => {
      const expectedActions = [
        {
