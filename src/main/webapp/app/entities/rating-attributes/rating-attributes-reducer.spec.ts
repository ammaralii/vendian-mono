...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './rating-attributes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RATINGATTRIBUTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_RATINGATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RATINGATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RATINGATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RATINGATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RATINGATTRIBUTES actions', async () => {
      const expectedActions = [
        {
