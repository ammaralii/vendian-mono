...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './pc-rater-attributes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PCRATERATTRIBUTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PCRATERATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PCRATERATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PCRATERATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PCRATERATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PCRATERATTRIBUTES actions', async () => {
      const expectedActions = [
        {
