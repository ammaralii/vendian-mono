...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIMDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIMDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIMDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIMDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIMDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIMDETAILS actions', async () => {
      const expectedActions = [
        {
