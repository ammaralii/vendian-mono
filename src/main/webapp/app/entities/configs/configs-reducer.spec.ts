...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './configs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONFIGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONFIGS actions', async () => {
      const expectedActions = [
        {
