...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-detail-adjustment-logs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEDETAILADJUSTMENTLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEDETAILADJUSTMENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEDETAILADJUSTMENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEDETAILADJUSTMENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEDETAILADJUSTMENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEDETAILADJUSTMENTLOGS actions', async () => {
      const expectedActions = [
        {
