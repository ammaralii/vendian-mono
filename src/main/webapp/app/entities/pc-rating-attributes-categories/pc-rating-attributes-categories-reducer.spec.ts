...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './pc-rating-attributes-categories.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PCRATINGATTRIBUTESCATEGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PCRATINGATTRIBUTESCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PCRATINGATTRIBUTESCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PCRATINGATTRIBUTESCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PCRATINGATTRIBUTESCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PCRATINGATTRIBUTESCATEGORIES actions', async () => {
      const expectedActions = [
        {
