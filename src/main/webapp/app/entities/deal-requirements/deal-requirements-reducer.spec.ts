...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './deal-requirements.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALREQUIREMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALREQUIREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALREQUIREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALREQUIREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALREQUIREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALREQUIREMENTS actions', async () => {
      const expectedActions = [
        {
