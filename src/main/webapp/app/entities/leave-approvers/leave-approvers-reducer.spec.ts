...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEAPPROVERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEAPPROVERS actions', async () => {
      const expectedActions = [
        {
