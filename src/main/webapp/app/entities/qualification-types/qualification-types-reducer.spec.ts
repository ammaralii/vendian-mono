...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './qualification-types.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUALIFICATIONTYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUALIFICATIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUALIFICATIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUALIFICATIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUALIFICATIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUALIFICATIONTYPES actions', async () => {
      const expectedActions = [
        {
