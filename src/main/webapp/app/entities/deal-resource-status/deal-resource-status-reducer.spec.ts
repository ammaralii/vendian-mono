...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './deal-resource-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALRESOURCESTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALRESOURCESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALRESOURCESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALRESOURCESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALRESOURCESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALRESOURCESTATUS actions', async () => {
      const expectedActions = [
        {
