...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './notification-templates.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONTEMPLATES_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTIFICATIONTEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTIFICATIONTEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTIFICATIONTEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONTEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTIFICATIONTEMPLATES actions', async () => {
      const expectedActions = [
        {
