...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-compensation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEECOMPENSATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEECOMPENSATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEECOMPENSATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEECOMPENSATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEECOMPENSATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEECOMPENSATION actions', async () => {
      const expectedActions = [
        {
