...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALEVENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALEVENTS actions', async () => {
      const expectedActions = [
        {
