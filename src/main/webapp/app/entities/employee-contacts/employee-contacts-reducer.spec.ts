...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-contacts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEECONTACTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEECONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEECONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEECONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEECONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEECONTACTS actions', async () => {
      const expectedActions = [
        {
