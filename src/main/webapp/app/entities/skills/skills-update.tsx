...
export const SkillsUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...skillsEntity,
          createdat: convertDateTimeFromServer(skillsEntity.createdat),
          updatedat: convertDateTimeFromServer(skillsEntity.updatedat),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="vendianMonoApp.skills.home.createOrEditLabel" data-cy="SkillsCreateUpdateHeading">
            Create or edit a Skills
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="skills-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Name"
                id="skills-name"
                name="name"
