...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './skills.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SKILLS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SKILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SKILLS actions', async () => {
      const expectedActions = [
        {
