...
export const Skills = () => {
  ...
  return (
    <div>
            ...
            <tbody>
              {skillsList.map((skills, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{skills.name}</td>
                  <td>{skills.createdat ? <TextFormat type="date" value={skills.createdat} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{skills.updatedat ? <TextFormat type="date" value={skills.updatedat} format={APP_DATE_FORMAT} /> : null}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/skills/${skills.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/skills/${skills.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={skillsList && skillsList.length > 0 ? '' : 'd-none'}>
