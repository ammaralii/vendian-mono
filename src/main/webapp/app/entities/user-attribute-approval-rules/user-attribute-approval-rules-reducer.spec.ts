...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-attribute-approval-rules.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERATTRIBUTEAPPROVALRULES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERATTRIBUTEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERATTRIBUTEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERATTRIBUTEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERATTRIBUTEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERATTRIBUTEAPPROVALRULES actions', async () => {
      const expectedActions = [
        {
