...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEDETAILS actions', async () => {
      const expectedActions = [
        {
