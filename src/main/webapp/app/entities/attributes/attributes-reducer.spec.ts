...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRIBUTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTRIBUTES actions', async () => {
      const expectedActions = [
        {
