...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIMSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIMSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIMSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIMSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIMSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIMSTATUS actions', async () => {
      const expectedActions = [
        {
