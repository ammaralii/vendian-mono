...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './feedback-questions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKQUESTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEEDBACKQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEEDBACKQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEEDBACKQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEEDBACKQUESTIONS actions', async () => {
      const expectedActions = [
        {
