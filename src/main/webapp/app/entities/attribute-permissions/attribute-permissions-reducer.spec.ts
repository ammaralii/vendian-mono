...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './attribute-permissions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRIBUTEPERMISSIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTRIBUTEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTRIBUTEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTRIBUTEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTRIBUTEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTRIBUTEPERMISSIONS actions', async () => {
      const expectedActions = [
        {
