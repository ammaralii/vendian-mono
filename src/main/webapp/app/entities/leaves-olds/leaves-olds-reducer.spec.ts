...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVESOLDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVESOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVESOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVESOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVESOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVESOLDS actions', async () => {
      const expectedActions = [
        {
