...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERRATINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERRATINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERRATINGS actions', async () => {
      const expectedActions = [
        {
