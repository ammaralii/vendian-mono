...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './locations.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOCATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCATIONS actions', async () => {
      const expectedActions = [
        {
