...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-job-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEJOBINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEJOBINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEJOBINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEJOBINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEJOBINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEJOBINFO actions', async () => {
      const expectedActions = [
        {
