...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIMAPPROVERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIMAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIMAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIMAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIMAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIMAPPROVERS actions', async () => {
      const expectedActions = [
        {
