...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-requests-olds.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEREQUESTSOLDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEREQUESTSOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEREQUESTSOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEREQUESTSOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEREQUESTSOLDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEREQUESTSOLDS actions', async () => {
      const expectedActions = [
        {
