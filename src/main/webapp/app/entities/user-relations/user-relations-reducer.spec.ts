...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERRELATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERRELATIONS actions', async () => {
      const expectedActions = [
        {
