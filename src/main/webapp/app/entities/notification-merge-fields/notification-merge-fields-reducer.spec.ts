...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './notification-merge-fields.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONMERGEFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTIFICATIONMERGEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTIFICATIONMERGEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTIFICATIONMERGEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONMERGEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTIFICATIONMERGEFIELDS actions', async () => {
      const expectedActions = [
        {
