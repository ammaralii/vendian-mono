...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEQUELIZEMETA_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEQUELIZEMETA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEQUELIZEMETA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEQUELIZEMETA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEQUELIZEMETA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEQUELIZEMETA actions', async () => {
      const expectedActions = [
        {
