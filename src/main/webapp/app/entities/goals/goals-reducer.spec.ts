...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './goals.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GOALS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GOALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GOALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GOALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GOALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GOALS actions', async () => {
      const expectedActions = [
        {
