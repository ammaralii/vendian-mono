...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './claim-request-views.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIMREQUESTVIEWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIMREQUESTVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIMREQUESTVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIMREQUESTVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIMREQUESTVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIMREQUESTVIEWS actions', async () => {
      const expectedActions = [
        {
