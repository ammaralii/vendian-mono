...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-ratings-remarks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERRATINGSREMARKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERRATINGSREMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERRATINGSREMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERRATINGSREMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERRATINGSREMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERRATINGSREMARKS actions', async () => {
      const expectedActions = [
        {
