...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIMIMAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIMIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIMIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIMIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIMIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIMIMAGES actions', async () => {
      const expectedActions = [
        {
