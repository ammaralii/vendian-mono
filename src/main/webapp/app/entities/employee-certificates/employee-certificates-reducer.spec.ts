...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-certificates.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEECERTIFICATES_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEECERTIFICATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEECERTIFICATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEECERTIFICATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEECERTIFICATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEECERTIFICATES actions', async () => {
      const expectedActions = [
        {
