...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOODGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BLOODGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOODGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOODGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOODGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOODGROUPS actions', async () => {
      const expectedActions = [
        {
