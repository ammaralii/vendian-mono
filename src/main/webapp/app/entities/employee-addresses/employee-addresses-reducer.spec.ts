...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-addresses.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEADDRESSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEADDRESSES actions', async () => {
      const expectedActions = [
        {
