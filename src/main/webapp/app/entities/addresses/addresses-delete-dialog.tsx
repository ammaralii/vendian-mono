...
export const AddressesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="vendianMonoApp.addresses.delete.question">Are you sure you want to delete Addresses {addressesEntity.id}?</ModalBody>
      <ModalFooter>
