...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './addresses.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADDRESSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADDRESSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADDRESSES actions', async () => {
      const expectedActions = [
        {
