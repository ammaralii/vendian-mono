...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-emergency-contacts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEEMERGENCYCONTACTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEEMERGENCYCONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEEMERGENCYCONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEEMERGENCYCONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEEMERGENCYCONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEEMERGENCYCONTACTS actions', async () => {
      const expectedActions = [
        {
