...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './goal-group-mappings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GOALGROUPMAPPINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GOALGROUPMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GOALGROUPMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GOALGROUPMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GOALGROUPMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GOALGROUPMAPPINGS actions', async () => {
      const expectedActions = [
        {
