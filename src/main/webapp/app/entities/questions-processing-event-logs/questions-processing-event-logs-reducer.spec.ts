...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './questions-processing-event-logs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONSPROCESSINGEVENTLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUESTIONSPROCESSINGEVENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUESTIONSPROCESSINGEVENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUESTIONSPROCESSINGEVENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONSPROCESSINGEVENTLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUESTIONSPROCESSINGEVENTLOGS actions', async () => {
      const expectedActions = [
        {
