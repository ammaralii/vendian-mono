...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './notification-events.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONEVENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTIFICATIONEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTIFICATIONEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTIFICATIONEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTIFICATIONEVENTS actions', async () => {
      const expectedActions = [
        {
