...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './deal-requirement-matching-resources.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALREQUIREMENTMATCHINGRESOURCES_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALREQUIREMENTMATCHINGRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALREQUIREMENTMATCHINGRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALREQUIREMENTMATCHINGRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALREQUIREMENTMATCHINGRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALREQUIREMENTMATCHINGRESOURCES actions', async () => {
      const expectedActions = [
        {
