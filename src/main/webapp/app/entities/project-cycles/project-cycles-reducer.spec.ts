...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTCYCLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTCYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTCYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTCYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTCYCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTCYCLES actions', async () => {
      const expectedActions = [
        {
