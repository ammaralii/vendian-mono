...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employment-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYMENTHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYMENTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYMENTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYMENTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYMENTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYMENTHISTORY actions', async () => {
      const expectedActions = [
        {
