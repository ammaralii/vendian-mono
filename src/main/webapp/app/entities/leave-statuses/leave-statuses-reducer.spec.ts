...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVESTATUSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVESTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVESTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVESTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVESTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVESTATUSES actions', async () => {
      const expectedActions = [
        {
