...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTROLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTROLES actions', async () => {
      const expectedActions = [
        {
