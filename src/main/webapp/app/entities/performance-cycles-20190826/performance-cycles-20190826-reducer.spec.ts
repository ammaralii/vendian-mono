...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './performance-cycles-20190826.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERFORMANCECYCLES20190826_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERFORMANCECYCLES20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERFORMANCECYCLES20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERFORMANCECYCLES20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERFORMANCECYCLES20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERFORMANCECYCLES20190826 actions', async () => {
      const expectedActions = [
        {
