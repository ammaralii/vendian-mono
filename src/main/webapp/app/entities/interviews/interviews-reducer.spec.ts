...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERVIEWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERVIEWS actions', async () => {
      const expectedActions = [
        {
