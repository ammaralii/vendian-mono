...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './feedback-requests.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKREQUESTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEEDBACKREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEEDBACKREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEEDBACKREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEEDBACKREQUESTS actions', async () => {
      const expectedActions = [
        {
