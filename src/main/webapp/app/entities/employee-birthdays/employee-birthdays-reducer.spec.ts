...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-birthdays.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEBIRTHDAYS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEBIRTHDAYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEBIRTHDAYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEBIRTHDAYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEBIRTHDAYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEBIRTHDAYS actions', async () => {
      const expectedActions = [
        {
