...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-profile-history-logs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROFILEHISTORYLOGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROFILEHISTORYLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEPROFILEHISTORYLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEPROFILEHISTORYLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEPROFILEHISTORYLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEPROFILEHISTORYLOGS actions', async () => {
      const expectedActions = [
        {
