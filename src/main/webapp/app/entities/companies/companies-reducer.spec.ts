...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './companies.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANIES actions', async () => {
      const expectedActions = [
        {
