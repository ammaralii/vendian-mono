...
export const CompaniesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="vendianMonoApp.companies.delete.question">Are you sure you want to delete Companies {companiesEntity.id}?</ModalBody>
      <ModalFooter>
