...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './events.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVENTS actions', async () => {
      const expectedActions = [
        {
