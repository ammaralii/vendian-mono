...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './designation-job-descriptions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESIGNATIONJOBDESCRIPTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DESIGNATIONJOBDESCRIPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DESIGNATIONJOBDESCRIPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DESIGNATIONJOBDESCRIPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DESIGNATIONJOBDESCRIPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DESIGNATIONJOBDESCRIPTIONS actions', async () => {
      const expectedActions = [
        {
