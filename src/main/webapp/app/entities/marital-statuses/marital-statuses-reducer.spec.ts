...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARITALSTATUSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARITALSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARITALSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARITALSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARITALSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARITALSTATUSES actions', async () => {
      const expectedActions = [
        {
