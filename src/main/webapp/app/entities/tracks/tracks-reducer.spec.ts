...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tracks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRACKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRACKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRACKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRACKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRACKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRACKS actions', async () => {
      const expectedActions = [
        {
