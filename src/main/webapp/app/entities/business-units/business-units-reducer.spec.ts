...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSUNITS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUSINESSUNITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSINESSUNITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSINESSUNITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSUNITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSINESSUNITS actions', async () => {
      const expectedActions = [
        {
