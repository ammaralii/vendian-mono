...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVESCOPY_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVESCOPY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVESCOPY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVESCOPY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVESCOPY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVESCOPY actions', async () => {
      const expectedActions = [
        {
