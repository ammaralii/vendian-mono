...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-project-ratings-20190826.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROJECTRATINGS20190826_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEEPROJECTRATINGS20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEEPROJECTRATINGS20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEEPROJECTRATINGS20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEEPROJECTRATINGS20190826 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEEPROJECTRATINGS20190826 actions', async () => {
      const expectedActions = [
        {
