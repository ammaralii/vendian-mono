...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RATINGOPTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RATINGOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RATINGOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RATINGOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RATINGOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RATINGOPTIONS actions', async () => {
      const expectedActions = [
        {
