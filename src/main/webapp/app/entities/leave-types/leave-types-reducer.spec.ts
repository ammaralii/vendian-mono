...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVETYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVETYPES actions', async () => {
      const expectedActions = [
        {
