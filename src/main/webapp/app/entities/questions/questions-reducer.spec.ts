...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './questions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUESTIONS actions', async () => {
      const expectedActions = [
        {
