...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leave-escalation-approvers.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEESCALATIONAPPROVERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEESCALATIONAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEESCALATIONAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEESCALATIONAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEESCALATIONAPPROVERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEESCALATIONAPPROVERS actions', async () => {
      const expectedActions = [
        {
